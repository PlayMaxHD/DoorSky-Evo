...
$description[$replaceText[$replaceText[$getServerVar[language];Español;se a muteado a ];Inglés it has been mutated to ]$username[$mentioned[1]]]
...
$onlyIf[$mentioned[1]!=$AuthoriD;:x: no puedes mutearte]`
})