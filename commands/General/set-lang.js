...
$onlyPerms[manageserver;$replaceText[$replaceText[$getServerVar[language];Español;:x: no tienes el permiso de \`MANAGE_SERVER\`];Inglés;:x: you don't have the \`MANAGE_SERVER\` permission]`
})